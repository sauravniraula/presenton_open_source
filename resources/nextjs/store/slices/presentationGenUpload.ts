...
export const presentationGenUploadSlice = createSlice({
  ...
  initialState,
  reducers: {
    setPptGenUploadState: (state, action: PayloadAction<Partial<PresentationGenUploadState>>) => {
      ...
      state.promptTablesExtraction = payload.promptTablesExtraction
...
export const { setPptGenUploadState, setQuestions, setStoryResponse } = presentationGenUploadSlice.actions;
