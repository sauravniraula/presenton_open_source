...
import { setThemeColors, setTheme, setLoadingState, loadSavedTheme } from '../store/themeSlice';
...
const CustomThemeSettings = ({ onClose, presentationId }: CustomThemeSettingsProps) => {
    ...
    const handleSave = async () => {
        try {
            ...
            dispatch(setThemeColors({ ...draftColors, theme: 'custom' as ThemeType }));
            ...
            root.style.setProperty('--custom-slide-heading', draftColors.slideHeading);
            root.style.setProperty('--custom-slide-description', draftColors.slideDescription);
            ...
            PresentationGenerationApi.setThemeColors(

                presentationId,
                { name: 'custom', colors: draftColors }
            ).catch(error => {
            ...
            <div className="h-[60vh]  overflow-y-auto custom_scrollbar pr-2 pb-2">
                ...
                <div className=" w-full space-y-2">
                    ...
                    <div
                        ...
                        <div className="w-full h-28 rounded-lg shadow-sm transition-all overflow-hidden"
                            style={{
                                backgroundColor: draftColors.slideBg,
                                padding: '0.75rem',
                            }}
                        >
                            <div style={{ color: draftColors.slideTitle }} className="text-base font-bold mb-2">
                                Sample Title
                            </div>
                            <div style={{ color: draftColors.slideHeading }} className="text-sm mb-1">
                                Heading
                            </div>
                            <div style={{ color: draftColors.slideDescription }} className="text-xs">
                                Description text
                            </div>
                            <div
                ...
                <div className="w-full grid grid-cols-1 gap-4">
                    {colorInputs.map(({ key, label, icon }) => (
                        <div key={key} className="flex items-center gap-4 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                            <div className="relative group">
                                ...
                                <div
                                    ...
                                    style={{ backgroundColor: draftColors[key as keyof typeof draftColors] as string }}
                                />
                            </div>
