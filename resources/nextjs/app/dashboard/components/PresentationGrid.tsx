...
export const PresentationGrid = ({
    ...
    const handleCreateNewPresentation = () => {
        ...
        sendMpEvent(MixpanelEventName.createNewPresentationClicked);
        if (type === 'slide') {
            //? Mixpanel User Tracking
    ...
    const CreateNewCard = () => (
        <div onClick={handleCreateNewPresentation} className="flex flex-col gap-4 min-h-[200px] cursor-pointer group border border-gray-400 hover:border-primary/60 bg-white/70 hover:bg-white/80 rounded-lg items-center justify-center transition-all duration-300">
            ...
            <div className="text-center">
                <h3 className="font-semibold text-gray-700 group-hover:text-gray-900 mb-1">Create {type === 'slide' ? 'New' : 'Video'} Presentation</h3>
                <p className="text-sm text-gray-500 group-hover:text-gray-600 px-4">Start from scratch and bring your ideas to life</p>
            </div>
        </div>
    );
